...
execute if score rerun_terrain settings matches 0 at @e[tag=chunk_aligned, limit=1] run function practice:_start/terrain/load
...
execute if score rerun_terrain settings matches 1 at @e[tag=chunk_aligned, limit=1] run function bastionbuilder:regenerate
